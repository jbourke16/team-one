      ...
      <div>
        <div className="header-container">
          ...
          <img
            ...
            src="https://github.com/jbourke16/team-rekt-frontend/blob/dev/public/logos/LOGO-OUTLINE-BLACK.png?raw=true"
          />
          <img
            className="monster-header"
            src="https://github.com/erichowington/Anime-Nexus/blob/main/public/images/MONSTERS2.png?raw=true"
          />
